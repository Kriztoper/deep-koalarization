...
from colorization import Feedforward_Colorization, Refinement
...
fwd_col = Feedforward_Colorization()
ref = Refinement()

opt_operations = training_pipeline(fwd_col, ref, learning_rate, batch_size)
evaluations_ops = evaluation_pipeline(fwd_col, ref, val_number_of_images)
train_fwd_writer, train_ref_writer, val_fwd_writer, val_ref_writer = metrics_system(run_id, sess)
...
with sess.as_default():
    ...
    for epoch in range(epochs):
        ...
        for batch in range(batches):
            ...
            print_term('Cost_Feedforward: {} Global step: {}'
