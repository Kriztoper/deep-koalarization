...
def training_pipeline(col, ref, learning_rate, batch_size):#lowres_col, ref, learning_rate, batch_size):
    ...
    imgs_lab = tf.concat([imgs_l, imgs_true_ab], axis=3)#imgs_lowres_ab, imgs_ab], axis=3)
...
def evaluation_pipeline(col, ref, number_of_images):#lowres_col, ref, number_of_images):
    ...
    imgs_lab_val = tf.concat([imgs_l_val, imgs_ab_val], axis=3)#imgs_lowres_ab_val, imgs_ab_val], axis=3)
...
def metrics_system(run_id, sess):
    ...
    return train_col_writer, train_ref_writer, val_col_writer, val_ref_writer#train_lowres_writer, train_ref_writer, val_col_writer, val_lowres_writer, val_ref_writer
